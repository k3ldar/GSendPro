...
namespace GSendTests.GCService
{
    ...
    public class GCodeProcessorTests
    {
        ...
        {
            new GCodeProcessor(new MockMachineProvider(), null, new MockComPortFactory(), new MockServiceProvider());
        }
        ...
        {
            new GCodeProcessor(new MockMachineProvider(), new MachineModel(), null, new MockServiceProvider());
        }
