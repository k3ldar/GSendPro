...
[assembly: SuppressMessage("Major Code Smell", "S1168:Empty arrays and collections should be returned instead of null", Justification = "Null is good when that is expected", Scope = "member", Target = "~P:GSendShared.Plugins.InternalPlugins.ServerMenu.ServerMenuPlugin.ToolbarItems")]
