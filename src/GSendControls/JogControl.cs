        ...
        public List<IShortcut> GetShortcuts()
        {
            ...
            [
                ...
                new ShortcutModel(groupName, GSend.Language.Resources.ShortcutNameZMinus,
                    [(int) Keys.Control,(int) Keys.Down],
